...
const socialIcons = [
  { href: BRAND.social.instagram, icon: <IconInstagram />, hoverColor: '#c1ff72' },
  { href: BRAND.social.facebook, icon: <IconFacebook />, hoverColor: '#a8d8f0' },
...
const styles: Record<string, React.CSSProperties> = {
  footer: { backgroundColor: '#141414', padding: '4rem 1.5rem 0', borderTop: '1px solid rgba(255,255,255,0.05)' },
  ...
  tagline: { fontFamily: 'Montserrat, sans-serif', fontWeight: 600, fontSize: '0.8rem', color: '#a8d8f0', margin: 0 },
  ...
  waBtn: { display: 'inline-flex', alignItems: 'center', gap: '0.4rem', backgroundColor: '#c1ff72', color: '#1e1e1e', fontFamily: 'Montserrat, sans-serif', fontWeight: 700, fontSize: '0.8rem', padding: '0.6rem 1.1rem', borderRadius: '8px', textDecoration: 'none', transition: 'background-color 0.2s ease', marginTop: '0.5rem', width: 'fit-content' },
  accentLine: { height: '2px', background: 'linear-gradient(to right, transparent, #5ba8d4, #c1ff72, #5ba8d4, transparent)', maxWidth: '1100px', margin: '0 auto', opacity: 0.4 },
  ...
  copy: { fontFamily: 'Montserrat, sans-serif', fontWeight: 400, fontSize: '0.78rem', color: '#4b4b4b', margin: 0 },
}
